...
function AuthForm() {
  ...
  const submitHandlerCreate = (e) => {
    ...
    if (isLogin) {
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAhtJKjKn1JstR6g8QT221oxblZOUv2rkQ";
    } else {
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAhtJKjKn1JstR6g8QT221oxblZOUv2rkQ";
    }
    fetch(url, {
      method: "POST",
      body: JSON.stringify({
