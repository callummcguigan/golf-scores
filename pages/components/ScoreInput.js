...
function ScoreInput(props) {
    ...
    const url = 'https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyAhtJKjKn1JstR6g8QT221oxblZOUv2rkQ'
        ...
        <div className="container">
            ...
            <Form onSubmit={submitHandler} className="form">
                <Form.Group className="mb-3" >
                    <Form.Control type="text" placeholder="Course Name" ref={courseName} required/>
                </Form.Group>
                <Form.Group className="mb-3" >
                    <Form.Control type="date" placeholder="Date Played" ref={date} required/>
                </Form.Group>
                <Form.Group className="mb-3" >
                    <Form.Control type="number" placeholder="Score" ref={score} min="18" required/>
                </Form.Group>
                <Form.Group className="mb-3">
                    <Form.Control type="number" placeholder="Greens Hit" ref={greens} min="0" max="18" required/>
                </Form.Group>
                <Form.Group className="mb-3">
                    <Form.Control type="number" placeholder="Fairways Hit" ref={fairways} min="0" max="18" required/>
                </Form.Group>
                <Form.Group className="mb-3">
                    <Form.Control type="number" placeholder="Putts" ref={putts} min="0" required/>
                </Form.Group>
